       ...
       <?php   
        ...
        <form method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
            <table>
                ...
                <tr>
                    <td>Detail</td>
                    <td>: <input type="text" name="detail" value="Donation to <?php echo $org_name; ?>" placeholder="Description of the transaction" size="30"></td>
                </tr>
                <tr>
                    <td>Amount</td>
                ...
                <tr>
                    <td>Customer Name</td>
                    <td>: <input type="text" name="name" value="<?php echo $donorname?>" placeholder="Name of the customer" size="30"></td>
                </tr>
                <tr>
                    <td>Customer Email</td>
                    <td>: <input type="text" name="email" value="<?php echo $donoremail ?>" placeholder="Email of the customer" size="30"></td>
                </tr>
                <tr>
                    <td>Customer Contact No</td>
                    <td>: <input type="text" name="phone" value="<?php echo $donor_tel ?>" placeholder="Contact number of customer" size="30"></td>
                </tr>
                <tr>
