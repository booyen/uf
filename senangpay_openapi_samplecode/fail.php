...
<div class="content bg-white text-center pulldown overflow-hidden">
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            <!-- Error Titles -->
            <h2 class="h2 font-w300 text-danger animated bounceInDown">Your donation is failed</h2>
            <h2 class="h4 font-w300 push-50 animated fadeInUp">If problem persist please contact our Customer Service. 
