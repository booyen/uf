  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index.php" class="logo"><b>UmmahFund </b>Admin</a>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">UmahFund Admin</a></strong>
      </footer>
    </div><!-- ./wrapper -->
