...
$one->inc_sidebar                  = 'base_sidebar_general.php';
...
$one->main_nav                     = array(
    array(
        ...
        'url'   => '../donor_base/base_pages_profile_donors.php'
    ),
    array(
    ...
    array(
     ...
     array(
        ...
        'icon'  => 'si si-heart',
        'url'   => 'donor_base/base_pages_favorite.php'
    ),
    
     array(
        'name'  => '<span class="sidebar-mini-hide">History</span>',
        'icon'  => 'fa fa-history',
        'url'   => 'donor_base/base_pages_history.php'
    ),
   ...
   array(
        'name'  => '<span class="sidebar-mini-hide">Support Center</span>',
        'icon'  => 'si si-envelope',
        'url'   => 'general_base/frontend_support.php'
    ),
